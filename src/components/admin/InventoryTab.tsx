                        ...
                        <form id="productForm" onSubmit={handlePublish} className="space-y-12">
                            ...
                            <section className="space-y-6">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    ...
                                    <div><label className="text-xs font-bold text-gray-500">Strap Material</label><select className="w-full p-3 bg-white border rounded-xl" value={formData.strapMaterial || ""} onChange={e => setFormData({...formData, strapMaterial: e.target.value})}><option value="">Select Material</option><option>Leather</option><option>Metal</option><option>Chain</option><option>Silicon</option></select></div>
