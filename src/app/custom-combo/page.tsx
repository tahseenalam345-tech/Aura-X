...
import { Check, Sparkles, ShoppingBag, Info, ArrowUpDown, X, Trash2, Star } from "lucide-react";
...
export default function CustomComboPage() {
  ...
  return (
    <main className="min-h-screen bg-[#FDFBF7] text-aura-brown pb-20 relative">
      <Navbar />
            ...
            <motion.div initial={{ scale: 0.9, opacity: 0, y: 20 }} animate={{ scale: 1, opacity: 1, y: 0 }} exit={{ scale: 0.9, opacity: 0, y: 20 }} className="relative bg-white rounded-[2rem] shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto z-10 flex flex-col md:flex-row overflow-hidden border border-aura-gold/20">
              ...
              <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center bg-white">
                  ...
                  <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="text-xs font-bold text-gray-500">{quickViewProduct.rating || '4.8'} / 5.0</span>
                  </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {currentItems.map((product) => {
                  ...
                  return (
                    ...
                    >
                      {/* 🚀 FIXED: Now opens the Popup Modal instead of a new tab */}
                      <button 
                      ...
                      <p className="text-xs font-serif font-bold text-aura-gold mt-1">Rs. {product.price.toLocaleString()}</p>
